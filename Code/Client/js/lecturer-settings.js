document.addEventListener("DOMContentLoaded", () => {
    ...
    if (changePasswordForm) {
        changePasswordForm.addEventListener("submit", async (e) => {
            ...
            if (!oldPass) {
                showAppNotification("Vui lòng nhập mật khẩu hiện tại!");
                return;
            }

            if (!Object.values(passwordRules).every(Boolean)) {
                showAppNotification("Mật khẩu mới phải có ít nhất 8 ký tự, chữ hoa, chữ thường, chữ số và ký tự đặc biệt!");
                return;
            }
            ...
            try {
                ...
                if (!response.ok || !result.success) {
                    showAppNotification(result.message || "Đổi mật khẩu thất bại!");
                    return;
                }
                ...
                showAppNotification("Không thể kết nối đến máy chủ. Vui lòng thử lại!");
            } finally {
                if (submitButton) {
